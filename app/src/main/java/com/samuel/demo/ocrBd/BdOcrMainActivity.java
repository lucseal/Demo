...
public class BdOcrMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bd_ocr);
        ...
        findViewById(R.id.general_basic_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BdOcrMainActivity.this, CameraActivity.class);
        ...
        findViewById(R.id.idcard_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BdOcrMainActivity.this, IDCardActivity.class);
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(),  "O8ZzLdxv66qKKs0jfemsGPYn", "HBYc9n8Arp2I066XrCF8aeWjo2CS7V5d");
    }
